...
def test_should_raise_error_in_duplicate_user_role(user, role, user_role):
    user_role_action = UserRoleAction()
    with pytest.raises(UserAlreadyInRole):
        user_role_action.set_role(user, role)


def test_remove_all_users_of_a_role(role, user, user_role, other_user, other_user_in_role):
    user_role_action = UserRoleAction()
...
def test_remove_all_roles_for_a_user(user, user_role, role, role_user, role_writer):
    user_role_action = UserRoleAction()
